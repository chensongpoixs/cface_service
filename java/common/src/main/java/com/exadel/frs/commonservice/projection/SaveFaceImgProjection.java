...
public record SaveFaceImgProjection(long subId, int deviceId, int timestamp,   String imgUrl, String subImgUrl, int gender, int minAge, int maxAge, Float similarity, int boxMinX, int boxMinY, int boxMaxX, int boxMaxY)
{
